...
var Events = /*#__PURE__*/function () {
  function Events(threesixty, options) {
    ...
    var dragTo = function dragTo(position, tolerance) {
      if (_classPrivateFieldGet(_dragOrigin, _this) === null) {
        return;
      }
      var direction = (0, _geometry.dragDirection)(_classPrivateFieldGet(_dragOrigin, _this), position, tolerance);
      if (direction !== 0) {
        threesixty.stop();
        direction < 0 ? threesixty.prev() : threesixty.next();
        _classPrivateFieldSet(_dragOrigin, _this, position);
      }
    };
    _classPrivateFieldSet(_eventHandlers, this, {
      container: {
        mousedown: function mousedown(e) {
          return _classPrivateFieldSet(_dragOrigin, _this, pointerX(e));
        },
      ...
      global: {
        ...
        mousemove: function mousemove(e) {
          return dragTo(pointerX(e), _classPrivateFieldGet(_options, _this).dragTolerance);
        },
        touchmove: function touchmove(e) {
          return dragTo(pointerX(e), _classPrivateFieldGet(_options, _this).swipeTolerance);
        },
