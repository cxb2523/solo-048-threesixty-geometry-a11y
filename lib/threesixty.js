...
var _addedAriaLabel = /*#__PURE__*/new WeakMap();
var ThreeSixty = /*#__PURE__*/function () {
  function ThreeSixty(container, options) {
    ...
    _classPrivateFieldInitSpec(this, _addedAriaLabel, false);
  ...
  return _createClass(ThreeSixty, [{
    ...
    value: function goto(index) {
      _classPrivateFieldSet(_index, this, (0, _geometry.normalizeIndex)(index, _classPrivateFieldGet(_options, this).count));
      this._update();
    }
  }, {
    key: "play",
    ...
    value: function destroy() {
      ...
      if (_classPrivateFieldGet(_addedAriaLabel, this)) {
        this.container.removeAttribute('aria-label');
        _classPrivateFieldSet(_addedAriaLabel, this, false);
      }
    ...
    value: function _update() {
      if (this.sprite) {
        this.container.style.backgroundPositionX = -(0, _geometry.spriteColumn)(_classPrivateFieldGet(_index, this), _classPrivateFieldGet(_options, this).perRow) * this.containerWidth + 'px';
        this.container.style.backgroundPositionY = -(0, _geometry.spriteRow)(_classPrivateFieldGet(_index, this), _classPrivateFieldGet(_options, this).perRow) * this.containerHeight + 'px';
      } else {
      ...
      this.container.setAttribute('aria-valuenow', String(_classPrivateFieldGet(_index, this)));
    }
  }, {
    ...
    value: function _initContainer() {
      ...
      if (this.sprite) {
        ...
        var _spriteGrid = (0, _geometry.spriteGrid)(_classPrivateFieldGet(_options, this).count, _classPrivateFieldGet(_options, this).perRow),
          cols = _spriteGrid.cols,
          rows = _spriteGrid.rows;
    ...
    key: "_initAccessibility",
    value: function _initAccessibility() {
      this.container.setAttribute('tabindex', '0');
      this.container.setAttribute('role', 'slider');
      this.container.setAttribute('aria-valuemin', '0');
      this.container.setAttribute('aria-valuemax', String(Math.max(0, _classPrivateFieldGet(_options, this).count - 1)));
      if (!this.container.hasAttribute('aria-label') && !this.container.hasAttribute('aria-labelledby')) {
        ...
        _classPrivateFieldSet(_addedAriaLabel, this, true);
      }
    }
  }]);
}();
