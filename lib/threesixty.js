...
var _spriteColumns = /*#__PURE__*/new WeakMap();
...
var ThreeSixty = /*#__PURE__*/function () {
  function ThreeSixty(container, options) {
    ...
    _classPrivateFieldInitSpec(this, _spriteColumns, 1);
  ...
  return _createClass(ThreeSixty, [{
    ...
    value: function _update() {
      if (this.sprite) {
        var offset = (0, _geometry.spriteOffset)(_classPrivateFieldGet(_index, this), _classPrivateFieldGet(_spriteColumns, this), this.containerWidth, this.containerHeight);
    ...
    value: function _initContainer() {
      ...
      if (this.sprite) {
        ...
        var grid = (0, _geometry.spriteGrid)(_classPrivateFieldGet(_options, this).count, _classPrivateFieldGet(_options, this).perRow);
        _classPrivateFieldSet(_spriteColumns, this, grid.columns);
      ...
      this.container.setAttribute('aria-valuemax', String(Math.max(_classPrivateFieldGet(_options, this).count - 1, 0)));
      if (this.isResponsive) {
