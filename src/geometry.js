 ...
 */
export function dragStep(originX, currentX, tolerance) {
 ...
 */
export function spritePerRow(perRow) {
 ...
 */
export function spriteColumn(index, perRow) {
 ...
 */
export function spriteRow(index, perRow) {
...
export function spriteGrid(count, perRow) {
  const cols = spritePerRow(perRow);
